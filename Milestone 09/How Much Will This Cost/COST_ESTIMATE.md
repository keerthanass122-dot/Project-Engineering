...
| **Average** | ΓÇö | **[FILL IN]** | **[FILL IN]** | **[FILL IN]** |
...
*Formula: cost/req = (avg_prompt ├ù input_$/1M) + (avg_completion ├ù output_$/1M)*
*Daily = cost/req ├ù users ├ù 5 calls*
*Monthly = daily ├ù 30*

## Model Recommendation

[Sentence 1: Name the model. State the monthly cost at 100 users as a specific dollar figure.]
[Sentence 2: Explain the quality trade-off ΓÇö what do you gain or lose vs the most expensive option?]
