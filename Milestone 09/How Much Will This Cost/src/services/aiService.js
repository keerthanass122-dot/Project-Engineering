...
export async function summarizeNote(noteContent, userId) {
  ...
  //   data.usage.prompt_tokens    ΓåÉ tokens used by your system prompt + note
  //   data.usage.completion_tokens ΓåÉ tokens in the generated summary
  //   data.usage.total_tokens     ΓåÉ sum of both
